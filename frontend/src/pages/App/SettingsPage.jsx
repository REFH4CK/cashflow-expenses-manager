  ...
  return (
    <>
      <section className={`bg-[#1F252F] h-screen flex`}>
        ...
        <section className="flex flex-col gap-8 items-center w-full p-2 sm:p-4 sm:pt-[2rem] md:pt-[8rem] overflow-hidden">
          <Fade className="w-full" triggerOnce direction="up">
            <article className="bg-[#28303E] h-[35rem] sm:w-full md:w-[80%] md:h-[40rem] rounded-3xl shadow shadow-tree-poppy-700/50 mx-auto">
              ...
              <article className="flex items-center justify-center w-[17rem] h-[40%] sm:w-full sm:h-[35%] md:h-[30%] relative">
